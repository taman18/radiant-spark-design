...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium website design & development that turns visitors into clients. Trusted by 50+ ambitious brands." },
      { name: "author", content: "LumenStudio" },
      { property: "og:title", content: "LumenStudio — High-Converting Websites" },
      { property: "og:description", content: "Premium website design that drives leads, trust, and sales." },
